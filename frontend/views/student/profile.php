...
<div class="student-profile dashboard-container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="fas fa-user-cog text-danger"></i> <?= Html::encode($this->title) ?></h2>
    ...
    <div class="card shadow-sm content-card" style="background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1);">
        <div class="card-body">
            ...
            <div class="row text-white">
                ...
                <div class="col-md-6 mb-3">
                    <?= $form->field($model, 'birth_date')->textInput(['type' => 'date', 'class' => 'form-control bg-dark text-white border-secondary']) ?>
                </div>
                <div class="col-md-12 mb-3">
                    <?= $form->field($model, 'address')->textarea(['rows' => 3, 'class' => 'form-control bg-dark text-white border-secondary']) ?>
                </div>
            </div>
