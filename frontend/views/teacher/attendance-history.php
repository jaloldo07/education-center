...
$this->title = Yii::t('app', 'Attendance History') . ' - ' . $group->name;
?>
...
<style>
    ...
    /* Bootstrap classlarini override qilamiz */
...
<div class="attendance-history-page">
    <div class="container">
        ...
        <div class="page-header animate__animated animate__fadeInDown">
            ...
            <div>
                <?= Html::a('<i class="fas fa-arrow-left"></i> ' . Yii::t('app', 'Back'), ['attendance', 'id' => $group->id], ['class' => 'btn-glass-back']) ?>
            </div>
        </div>
