...
// Voqealarni tayyorlash (Mantiq bir xil)
$events = [];
    ...
    while ($startDate <= $endDate) {
        if ($startDate->format('N') == $schedule->day_of_week) {
            $events[] = [
                ...
                'backgroundColor' => $groupColor, // Asosiy rang
                'borderColor' => 'transparent', // Border yo'q
                'textColor' => '#ffffff',
                'extendedProps' => [
                    'groupId' => $schedule->group_id,
                    // 🔥 TUZATISH: room_number o'rniga group->room
                    'room' => $schedule->group->room ?? 'Belgilanmagan', 
...
<style>
    ...
    /* 2. Guruhlar uchun ma'lumot (Info Card) */
    .legend-card {
    ...
    /* 3. Taqvim asosi (Calendar Wrapper) */
    .calendar-container {
    ...
    .fc-button:hover, .fc-button-active {
        background: #4361ee !important; /* var o'rniga aniq rang */
    ...
    .fc-col-header-cell-cushion {
        color: #4cc9f0; /* Kunlar uchun Neon ko'k */
    ...
    <div class="container">
        ...
        <div class="legend-card animate__animated animate__fadeInUp">
            <h6 class="text-white mb-3 text-uppercase small fw-bold" style="opacity: 0.7; letter-spacing: 1px;">
                <i class="fas fa-layer-group me-2"></i> <?= Yii::t('app', 'Sizning guruhlaringiz') ?>
            </h6>
            <div class="row">
                <?php 
                $colorIndex = 0;
                ...
                <div class="col-md-3 mb-3">
                    <div class="legend-item">
                        ...
                        <div>
                            <strong class="text-white d-block" style="line-height: 1.2;"><?= Html::encode($data['group']->name) ?></strong>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Yii2 dagi joriy tilni olamiz (masalan, 'ru-RU' dan 'ru' ni ajratib olamiz)
    var currentLang = '<?= substr(Yii::$app->language, 0, 2) ?>'; 
    
    var calendar = new FullCalendar.Calendar(calendarEl, {
        initialView: 'timeGridWeek',
        locale: currentLang, // 🔥 Sayt tili qanday bo'lsa, taqvim ham shu tilga o'tadi
        headerToolbar: {
            left: 'prev,next today',
            center: 'title',
            right: 'dayGridMonth,timeGridWeek,timeGridDay'
        },
        // buttonText ni o'chirib tashladik, chunki FullCalendar o'zi tarjima qiladi!
        ...
        eventClick: function(info) {
            ...
            alert(
                '📌 <?= Yii::t('app', 'Group') ?>: ' + info.event.title + '\n' +
                ...
                '👥 <?= Yii::t('app', 'Students') ?>: ' + props.students
            );
        },
