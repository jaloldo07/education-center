...
class GroupController extends Controller
{
    ...
    public function actionIndex()
    {
        $dataProvider = new ActiveDataProvider([
            'query' => Group::find()->with(['course', 'teacher'])->orderBy(['created_at' => SORT_DESC]),
            'pagination' => [
                'pageSize' => 20,
            ],
        ]);
    ...
    public function actionView($id)
    {
        ...
        $students = $model->getStudents()->all();
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success', 'Group has been updated successfully.');
            return $this->redirect(['view', 'id' => $model->id]);
        }
    ...
    public function actionDelete($id)
    {
        ...
        Yii::$app->session->setFlash('success', 'Group has been deleted successfully.');
